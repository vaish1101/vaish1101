...
Four rows, column-aligned on desktop (shared column widths, uniform row height, 820px canvas),
wrapped flow on mobile with 12.5px labels. Tiles are 34px with 24px logos (19px glyphs) and a small
